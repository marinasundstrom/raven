...
""";
    ...
    [Fact]
    public void MatchStatement_PrefixForm_ParsesAsExpressionStatementWithMatchExpression()
    {
        const string code = """
match true {
    0 => "zero"
...
""";
        ...
        var exprStmt = Assert.IsType<ExpressionStatementSyntax>(secondGlobal.Statement);
        var match = Assert.IsType<MatchExpressionSyntax>(exprStmt.Expression);
