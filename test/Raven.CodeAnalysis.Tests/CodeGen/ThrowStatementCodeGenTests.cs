...
""";
    ...
    [Fact]
    public void ThrowStatement_CatchGuard_FiltersExceptions()
    {
        var code = """
import System.*
...
""";
        ...
        var compilation = Compilation.Create(
                "throw-guarded-catch", new CompilationOptions(OutputKind.ConsoleApplication))
            .AddSyntaxTrees(syntaxTree)
            .AddReferences(references);
