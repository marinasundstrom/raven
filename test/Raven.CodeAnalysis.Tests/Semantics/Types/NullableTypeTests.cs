...
public class NullableTypeTests : CompilationTestBase
{
    ...
    {
        const string source = """
            func WriteLengths(input: string?) -> unit {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void GetTypeInfo_AssignmentOfNonNullValueEstablishesFlowFact(bool diagnosticsFirst)
    {
        const string source = """
            func Length() -> int {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void GetTypeInfo_NonNullInitializerEstablishesFlowFactForNullableLocal(bool diagnosticsFirst)
    {
        const string source = """
            func Length() -> int {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void GetTypeInfo_NullAssignmentInvalidatesInitializerFlowFact(bool diagnosticsFirst)
    {
        const string source = """
            func Length() -> int {
                var value: string? = "raven"
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void GetTypeInfo_AssignmentCopiesNarrowedValueFlowFact(bool diagnosticsFirst)
    {
        const string source = """
    ...
    {
        const string source = """
            func LengthAfterLoop(input: string?, repeat: bool) -> int {
                var value: string? = input
                if value is null {
                    return 0
                }
    ...
    [Fact]
    public void GetTypeInfo_AssignmentTargetIsNotRewrittenByFlowNarrowing()
    {
        const string source = """
            func Length(input: string?) -> int {
                var value: string? = input
        ...
        Assert.DoesNotContain(
            diagnostics,
            diagnostic => diagnostic.Descriptor == CompilerDiagnostics.LeftOfAssignmentMustBeAVariablePropertyOrIndexer);
    }
    ...
    {
        const string source = """
            func WriteLength(input: string?) -> unit {
                var value: string? = input
                while value is not null {
                    System.Console.WriteLine(value.Length)
                    value = null
    ...
    [Fact]
    public void GetTypeInfo_LoopExitUsesStateCapturedAtBreak()
    {
        const string source = """
            func Length(input: string?, stop: bool) -> int {
                var value: string? = input
                if value is null {
                    return 0
                }
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void GetTypeInfo_LoopExitIncludesMutationBeforeBreak(bool diagnosticsFirst)
    {
        const string source = """
            func Length(input: string?) -> int {
                var value: string? = input
    ...
    [Fact]
    public void GetTypeInfo_MutationOnBreakOnlyPathDoesNotPolluteEarlierBodyState()
    {
        const string source = """
            func WriteLength(input: string?) -> unit {
                var value: string? = input
    ...
    [Fact]
    public void GetTypeInfo_ContinueMutationContributesToLoopBackEdge()
    {
        const string source = """
            func WriteLengths(input: string?) -> unit {
                var value: string? = input
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void GetTypeInfo_TryAndCatchJoinPreservesNonNullFact(bool diagnosticsFirst)
    {
        const string source = """
            func Length(input: string?) -> int {
                var value: string? = input
    ...
    [Fact]
    public void GetTypeInfo_MultipleCatchExitsAreJoinedIndependently()
    {
        const string source = """
            import System.*
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void GetTypeInfo_ConstantFalseCatchFilterDoesNotContributeBodyMutationToExit(bool diagnosticsFirst)
    {
        const string source = """
            import System.*
    ...
    [Fact]
    public void GetTypeInfo_CatchAssignmentInvalidatesJoinedFact()
    {
        const string source = """
            func Length(input: string?) -> int {
                var value: string? = input
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void GetTypeInfo_RemainsMaybeNullAfterWhileNullGuardWithLabeledBreak(bool diagnosticsFirst)
    {
        const string source = """
            func Length(value: string?) -> int {
            outer: while value is null {
                    break outer
                }
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void GetTypeInfo_LabeledBreakContributesToTargetLoopExit(bool diagnosticsFirst)
    {
        const string source = """
            func Length(value: string?) -> int {
                if value is null {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void GetTypeInfo_LabeledBreakDoesNotCreateLoopBackEdge(bool diagnosticsFirst)
    {
        const string source = """
            func WriteLength(value: string?) -> unit {
                var local = value
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void GetTypeInfo_LabeledContinueContributesToLoopBackEdge(bool diagnosticsFirst)
    {
        const string source = """
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void GetTypeInfo_FinallyMutationOnNestedLabeledContinueReachesOuterBackEdge(bool diagnosticsFirst)
    {
        const string source = """
            func WriteLengths(value: string?) -> unit {
                var local = value
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void GetTypeInfo_ContinueInsideTryContributesToLoopBackEdge(bool diagnosticsFirst)
    {
        const string source = """
            func WriteLengths(value: string?) -> unit {
                var local = value
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void GetTypeInfo_FinallyMutationAppliesBeforeContinueLoopBackEdge(bool diagnosticsFirst)
    {
        const string source = """
            func WriteLengths(value: string?) -> unit {
                var local = value
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void GetTypeInfo_FinallyMutationAppliesBeforeBreakLoopExit(bool diagnosticsFirst)
    {
        const string source = """
            func Length(input: string?) -> int {
                var value: string? = input
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void GetTypeInfo_AbruptFinallySuppressesContinueLoopBackEdge(bool diagnosticsFirst)
    {
        const string source = """
            func WriteLengths(value: string?) -> unit {
                var local = value
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void GetTypeInfo_FinallyContinueReplacesBreakAndContributesLoopBackEdge(bool diagnosticsFirst)
    {
        const string source = """
            func WriteLengths(value: string?) -> unit {
                var local = value
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void GetTypeInfo_ConstantFalseLoopDoesNotApplyBodyMutationToFollowingState(bool diagnosticsFirst)
    {
        const string source = """
            func WriteLength(value: string?) -> unit {
                var local = value
