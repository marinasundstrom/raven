...
""";
        ...
        var verifier = CreateVerifier(code,
            expectedDiagnostics:
            [
                new DiagnosticResult(CompilerDiagnostics.TheNameDoesNotExistInTheCurrentContext.Id).WithSpan(2, 11, 2, 23).WithArguments("MissingError")
            ]);
...
""";
        ...
        var verifier = CreateVerifier(code,
            expectedDiagnostics:
            [
                new DiagnosticResult(CompilerDiagnostics.ThrowExpressionMustBeException.Id).WithSpan(2, 11, 2, 24).WithArguments("Error")
            ]);
...
""";
        ...
        var verifier = CreateVerifier(code,
            ...
            [
                ...
                new DiagnosticResult(CompilerDiagnostics.ThrowExpressionMustBeException.Id).WithSpan(2, 11, 2, 20).WithArguments("Error")
            ]);
