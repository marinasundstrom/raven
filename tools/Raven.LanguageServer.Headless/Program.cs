...
static IReadOnlyList<NamedReplayScenario> CreateReplayScenarios(string repoRoot)
{
    ...
    [
        new(
            ...
            Source("efcore-expression-trees", "src", "Program.rvn"),
        ...
        new(
            ...
            Source("fulfillment-workflow", "src", "FulfillmentWorkflow.rvn"),
            ReplayScenarioOperation.ProjectSequence,
            []),
        new(
            ...
            Source("fulfillment-workflow", "src", "FulfillmentWorkflow.rvn"),
            ReplayScenarioOperation.HoverPositions,
            [new PositionTarget(10, 20, "batchResult.propagation")]),
        new(
...
static IReadOnlyList<EditScenario> CreateEditScenarios(string repoRoot)
{
    ...
    [
        new(
            ...
            "Small project edit over namespace-imported input and parsing calls.",
            Project("hello-world"),
            Source("hello-world", "src", "Main.rvn"),
            [new EditReplacement("Write(\"Enter a number: \")", "Write(\"Enter an integer: \")")],
            [new("ReadLine()", "ReadLine"), new("int.Parse(input)", "Parse")]),
        new(
        ...
        new(
            ...
            Source("aspnet-minimal-api", "src", "Program.rvn"),
            [new EditReplacement("app.MapGet(\"/pets/{id}\", findPet)", "app.MapGet(\"/pets/{id:int}\", findPet)")],
            [new("MapGet(\"/pets/{id:int}\"", "MapGet"), new("findPet)", "findPet")]),
        new(
