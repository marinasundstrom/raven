...
public class Solution
{
    ...
    public Solution AddProject(ProjectId projectId, string name, string assemblyName, string language)
    {
        var project = new Project(this,
            new ProjectInfo(new ProjectAttributes
            (
                projectId,
                VersionStamp.Create(),
                name,
        ...
        var newProjects = Projects.ToList();
        newProjects.Add(project);

        return new Solution(this, _solutionInfo); //(Id, newProjects); // Return new immutable Solution
    }
