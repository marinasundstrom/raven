...
public static class TypeSymbolExtensionsForCodeGen
{
    ...
    private static Type GetSpecialClrType(SpecialType specialType, Compilation compilation)
    {
        ...
        return specialType switch
        {
            ...
            SpecialType.System_Collections_IEnumerable => FromCoreAssembly(compilation, "System.Collections.IEnumerable"),
            SpecialType.System_Collections_Generic_IEnumerable_T => FromCoreAssembly(compilation, "System.Collections.Generic.IEnumerable`1"),
            SpecialType.System_Collections_Generic_IEnumerator_T => FromCoreAssembly(compilation, "System.Collections.Generic.IEnumerator`1"),
            SpecialType.System_Collections_Generic_ICollection_T => FromCoreAssembly(compilation, "System.Collections.Generic.ICollection`1"),
            SpecialType.System_Collections_Generic_IList_T => FromCoreAssembly(compilation, "System.Collections.Generic.IList`1"),
            SpecialType.System_Collections_IEnumerator => FromCoreAssembly(compilation, "System.Collections.IEnumerator"),
