...
public class CompilationOptions
{
    ...
    private CompilationOptions(
        ...
        bool useUnicodeScalarChar = false, bool useGraphemeChar = false, bool captureAsyncExceptions = true, bool useHeapAsyncStateMachines = false, bool propagateAsyncCancellation = false)
    {
        PropagateAsyncCancellation = propagateAsyncCancellation;
        CaptureAsyncExceptions = captureAsyncExceptions;
        UseHeapAsyncStateMachines = useHeapAsyncStateMachines;
        UseUnicodeScalarChar = useUnicodeScalarChar;
        UseGraphemeChar = useGraphemeChar;
    ...
    public CompilationOptions WithAllowArrayCovariance(bool allow)
        => new(OutputKind, SpecificDiagnosticOptions, RunAnalyzers, DisabledAnalyzers, PerformanceInstrumentation, LoweringTrace, AsyncInvestigation, OverloadResolutionLogger, EmbedCoreTypes, AllowUnsafe, UseRuntimeAsync, AllowGlobalStatements, AllowNamespaceMembers, AllowNamespaceMemberImports, EnableSuggestions, _returnedValueHandlingMode, FrameworkProjectionMode, EnableIsNotNullNarrowing, ExternalConstantValues, EnabledAnalyzers, OptimizationLevel, SynthesizeStructuralToString, GeneratedCodeOptions, MetadataImportOptions, RuntimeIterationContract, RuntimePropagationContract, allow, TargetCoreAssemblyName, RuntimeUnitContract, RuntimeTypeOfContract, UseUnicodeScalarChar, UseGraphemeChar, CaptureAsyncExceptions, UseHeapAsyncStateMachines, PropagateAsyncCancellation);
    ...
    public CompilationOptions WithRuntimeUnitContract(RuntimeUnitContract? contract)
        => new(OutputKind, SpecificDiagnosticOptions, RunAnalyzers, DisabledAnalyzers, PerformanceInstrumentation, LoweringTrace, AsyncInvestigation, OverloadResolutionLogger, EmbedCoreTypes, AllowUnsafe, UseRuntimeAsync, AllowGlobalStatements, AllowNamespaceMembers, AllowNamespaceMemberImports, EnableSuggestions, _returnedValueHandlingMode, FrameworkProjectionMode, EnableIsNotNullNarrowing, ExternalConstantValues, EnabledAnalyzers, OptimizationLevel, SynthesizeStructuralToString, GeneratedCodeOptions, MetadataImportOptions, RuntimeIterationContract, RuntimePropagationContract, AllowArrayCovariance, TargetCoreAssemblyName, contract, RuntimeTypeOfContract, UseUnicodeScalarChar, UseGraphemeChar, CaptureAsyncExceptions, UseHeapAsyncStateMachines, PropagateAsyncCancellation);
    ...
    public CompilationOptions WithUnicodeScalarChar(bool enabled)
        => new(OutputKind, SpecificDiagnosticOptions, RunAnalyzers, DisabledAnalyzers, PerformanceInstrumentation, LoweringTrace, AsyncInvestigation, OverloadResolutionLogger, EmbedCoreTypes, AllowUnsafe, UseRuntimeAsync, AllowGlobalStatements, AllowNamespaceMembers, AllowNamespaceMemberImports, EnableSuggestions, _returnedValueHandlingMode, FrameworkProjectionMode, EnableIsNotNullNarrowing, ExternalConstantValues, EnabledAnalyzers, OptimizationLevel, SynthesizeStructuralToString, GeneratedCodeOptions, MetadataImportOptions, RuntimeIterationContract, RuntimePropagationContract, AllowArrayCovariance, TargetCoreAssemblyName, RuntimeUnitContract, RuntimeTypeOfContract, enabled, UseGraphemeChar, CaptureAsyncExceptions, UseHeapAsyncStateMachines, PropagateAsyncCancellation);

    /// <summary>Use text-valued Char for a runtime implementing the grapheme contract.</summary>
    public bool UseGraphemeChar { get; }

    public CompilationOptions WithGraphemeChar(bool enabled)
        => new(OutputKind, SpecificDiagnosticOptions, RunAnalyzers, DisabledAnalyzers, PerformanceInstrumentation, LoweringTrace, AsyncInvestigation, OverloadResolutionLogger, EmbedCoreTypes, AllowUnsafe, UseRuntimeAsync, AllowGlobalStatements, AllowNamespaceMembers, AllowNamespaceMemberImports, EnableSuggestions, _returnedValueHandlingMode, FrameworkProjectionMode, EnableIsNotNullNarrowing, ExternalConstantValues, EnabledAnalyzers, OptimizationLevel, SynthesizeStructuralToString, GeneratedCodeOptions, MetadataImportOptions, RuntimeIterationContract, RuntimePropagationContract, AllowArrayCovariance, TargetCoreAssemblyName, RuntimeUnitContract, RuntimeTypeOfContract, UseUnicodeScalarChar, enabled, CaptureAsyncExceptions, UseHeapAsyncStateMachines, PropagateAsyncCancellation);

    /// <summary>
    /// Whether compiler-generated async state machines capture exceptions into their builder.
    /// Disable only for an alternative target with terminal faults. This does not remove
    /// source exception handling or cleanup regions and does not change the task payload.
    /// </summary>
    public bool CaptureAsyncExceptions { get; }

    /// <summary>Provisional target policy: retain async state in a heap object.</summary>
    public bool UseHeapAsyncStateMachines { get; }

    /// <summary>Provisional target protocol: IsCancelled on awaiters and SetCancelled on builders.</summary>
    public bool PropagateAsyncCancellation { get; }

    public CompilationOptions WithAsyncCancellationPropagation(bool enabled)
        => new(OutputKind, SpecificDiagnosticOptions, RunAnalyzers, DisabledAnalyzers, PerformanceInstrumentation, LoweringTrace, AsyncInvestigation, OverloadResolutionLogger, EmbedCoreTypes, AllowUnsafe, UseRuntimeAsync, AllowGlobalStatements, AllowNamespaceMembers, AllowNamespaceMemberImports, EnableSuggestions, _returnedValueHandlingMode, FrameworkProjectionMode, EnableIsNotNullNarrowing, ExternalConstantValues, EnabledAnalyzers, OptimizationLevel, SynthesizeStructuralToString, GeneratedCodeOptions, MetadataImportOptions, RuntimeIterationContract, RuntimePropagationContract, AllowArrayCovariance, TargetCoreAssemblyName, RuntimeUnitContract, RuntimeTypeOfContract, UseUnicodeScalarChar, UseGraphemeChar, CaptureAsyncExceptions, UseHeapAsyncStateMachines, enabled);

    public CompilationOptions WithHeapAsyncStateMachines(bool enabled)
        => new(OutputKind, SpecificDiagnosticOptions, RunAnalyzers, DisabledAnalyzers, PerformanceInstrumentation, LoweringTrace, AsyncInvestigation, OverloadResolutionLogger, EmbedCoreTypes, AllowUnsafe, UseRuntimeAsync, AllowGlobalStatements, AllowNamespaceMembers, AllowNamespaceMemberImports, EnableSuggestions, _returnedValueHandlingMode, FrameworkProjectionMode, EnableIsNotNullNarrowing, ExternalConstantValues, EnabledAnalyzers, OptimizationLevel, SynthesizeStructuralToString, GeneratedCodeOptions, MetadataImportOptions, RuntimeIterationContract, RuntimePropagationContract, AllowArrayCovariance, TargetCoreAssemblyName, RuntimeUnitContract, RuntimeTypeOfContract, UseUnicodeScalarChar, UseGraphemeChar, CaptureAsyncExceptions, enabled, PropagateAsyncCancellation);

    public CompilationOptions WithAsyncExceptionCapture(bool enabled)
        => new(OutputKind, SpecificDiagnosticOptions, RunAnalyzers, DisabledAnalyzers, PerformanceInstrumentation, LoweringTrace, AsyncInvestigation, OverloadResolutionLogger, EmbedCoreTypes, AllowUnsafe, UseRuntimeAsync, AllowGlobalStatements, AllowNamespaceMembers, AllowNamespaceMemberImports, EnableSuggestions, _returnedValueHandlingMode, FrameworkProjectionMode, EnableIsNotNullNarrowing, ExternalConstantValues, EnabledAnalyzers, OptimizationLevel, SynthesizeStructuralToString, GeneratedCodeOptions, MetadataImportOptions, RuntimeIterationContract, RuntimePropagationContract, AllowArrayCovariance, TargetCoreAssemblyName, RuntimeUnitContract, RuntimeTypeOfContract, UseUnicodeScalarChar, UseGraphemeChar, enabled, UseHeapAsyncStateMachines, PropagateAsyncCancellation);
    ...
    public CompilationOptions WithRuntimePropagationContract(RuntimePropagationContract? contract)
        => new(OutputKind, SpecificDiagnosticOptions, RunAnalyzers, DisabledAnalyzers, PerformanceInstrumentation, LoweringTrace, AsyncInvestigation, OverloadResolutionLogger, EmbedCoreTypes, AllowUnsafe, UseRuntimeAsync, AllowGlobalStatements, AllowNamespaceMembers, AllowNamespaceMemberImports, EnableSuggestions, _returnedValueHandlingMode, FrameworkProjectionMode, EnableIsNotNullNarrowing, ExternalConstantValues, EnabledAnalyzers, OptimizationLevel, SynthesizeStructuralToString, GeneratedCodeOptions, MetadataImportOptions, RuntimeIterationContract, contract, AllowArrayCovariance, TargetCoreAssemblyName, RuntimeUnitContract, RuntimeTypeOfContract, UseUnicodeScalarChar, UseGraphemeChar, CaptureAsyncExceptions, UseHeapAsyncStateMachines, PropagateAsyncCancellation);
    ...
    public CompilationOptions WithRuntimeIterationContract(RuntimeIterationContract? contract)
        => new(OutputKind, SpecificDiagnosticOptions, RunAnalyzers, DisabledAnalyzers, PerformanceInstrumentation, LoweringTrace, AsyncInvestigation, OverloadResolutionLogger, EmbedCoreTypes, AllowUnsafe, UseRuntimeAsync, AllowGlobalStatements, AllowNamespaceMembers, AllowNamespaceMemberImports, EnableSuggestions, _returnedValueHandlingMode, FrameworkProjectionMode, EnableIsNotNullNarrowing, ExternalConstantValues, EnabledAnalyzers, OptimizationLevel, SynthesizeStructuralToString, GeneratedCodeOptions, MetadataImportOptions, contract, RuntimePropagationContract, AllowArrayCovariance, TargetCoreAssemblyName, RuntimeUnitContract, RuntimeTypeOfContract, UseUnicodeScalarChar, UseGraphemeChar, CaptureAsyncExceptions, UseHeapAsyncStateMachines, PropagateAsyncCancellation);


    public CompilationOptions WithMetadataImportOptions(MetadataImportOptions? options)
        => new(OutputKind, SpecificDiagnosticOptions, RunAnalyzers, DisabledAnalyzers, PerformanceInstrumentation, LoweringTrace, AsyncInvestigation, OverloadResolutionLogger, EmbedCoreTypes, AllowUnsafe, UseRuntimeAsync, AllowGlobalStatements, AllowNamespaceMembers, AllowNamespaceMemberImports, EnableSuggestions, _returnedValueHandlingMode, FrameworkProjectionMode, EnableIsNotNullNarrowing, ExternalConstantValues, EnabledAnalyzers, OptimizationLevel, SynthesizeStructuralToString, GeneratedCodeOptions, options, RuntimeIterationContract, RuntimePropagationContract, AllowArrayCovariance, TargetCoreAssemblyName, RuntimeUnitContract, RuntimeTypeOfContract, UseUnicodeScalarChar, UseGraphemeChar, CaptureAsyncExceptions, UseHeapAsyncStateMachines, PropagateAsyncCancellation);
