...
public static class RavenWorkspaceExtensions
{
    public static RavenWorkspace ToRavenWorkspace(this AdhocWorkspace workspace, string? sdkVersion = null, string? targetFramework = null)
    {
        ...
        {
            var projectId = raven.AddProject(project.Name, project.FilePath, project.AssemblyName, project.CompilationOptions, documentationOptions: project.DocumentationOptions, parseOptions: project.ParseOptions);
