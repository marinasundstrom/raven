...
public class Project
{
    ...
    private Document GetDocument(DocumentId documentId)
    {
        _documents = State.Documents.Select(d => new Document(this, d));
    ...
    public Project AddAdditionalDocument(string name, string filePath)
    {
        ...
        var newDocument = DocumentInfo.Create(
            documentId, name, [], SourceCodeKind.Regular, filePath, false, false);
