...
internal class CompilationUnitSyntaxParser : SyntaxParser
{
    ...
    private static bool IsPossibleCompilationUnitMemberStart(SyntaxToken token)
    {
        return token.Kind is SyntaxKind.ImportKeyword or SyntaxKind.GlobalKeyword or SyntaxKind.AliasKeyword or SyntaxKind.NamespaceKeyword or
            ...
            SyntaxKind.StaticKeyword or SyntaxKind.RefKeyword or SyntaxKind.AbstractKeyword or SyntaxKind.FinalKeyword or SyntaxKind.SealedKeyword or
        ...
        ref MemberOrder order)
    {
        ...
        else if (nextToken.IsKind(SyntaxKind.NamespaceKeyword))
        {
            ...
            order = MemberOrder.Members;
                 ...
                 nextToken.IsKind(SyntaxKind.StaticKeyword) || nextToken.IsKind(SyntaxKind.RefKeyword) || nextToken.IsKind(SyntaxKind.AbstractKeyword) ||
