...
internal sealed class UnionDeclarationParser : SyntaxParser
{
    ...
    internal UnionDeclarationSyntax Parse()
    {
        ...
        if (PeekToken().IsKind(SyntaxKind.LessThanToken))
        {
            ...
            typeParameterList = typeParser.ParseTypeParameterList();
        }
    ...
    private UnionCaseDeclarationSyntax ParseCase()
    {
        var attributeLists = AttributeDeclarationParser.ParseAttributeLists(this);
        ...
        {
            var typeParser = new TypeDeclarationParser(this);
            parameterList = typeParser.ParseParameterList();
        }

        return UnionCaseDeclaration(
            attributeLists,
            SyntaxList.Empty,
            identifier,
            typeParameterList,
