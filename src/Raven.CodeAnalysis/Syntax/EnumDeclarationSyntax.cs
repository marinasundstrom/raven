...
public partial class EnumDeclarationSyntax : BaseTypeDeclarationSyntax
{
    ...
    public EnumDeclarationSyntax(SyntaxToken enumKeyword, SyntaxToken identifier, SyntaxToken openBraceToken, SeparatedSyntaxList<EnumMemberDeclarationSyntax> members, SyntaxToken closeBraceToken, SyntaxToken? terminatorToken)
        : this(new InternalSyntax.EnumDeclarationSyntax(enumKeyword.Green, identifier.Green, openBraceToken.Green, members.Green, closeBraceToken.Green, terminatorToken?.Green, null))
    {
    }
}
...
public static partial class SyntaxFactory
{
    public static EnumDeclarationSyntax EnumDeclaration(SyntaxToken enumKeyword, SyntaxToken identifier, SyntaxToken openBraceToken, SeparatedSyntaxList<EnumMemberDeclarationSyntax> members, SyntaxToken closeBraceToken, SyntaxToken? terminatorToken = null)
        => new EnumDeclarationSyntax(enumKeyword, identifier, openBraceToken, members, closeBraceToken, terminatorToken);
}