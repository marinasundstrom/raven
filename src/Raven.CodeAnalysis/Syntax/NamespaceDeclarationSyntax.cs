...
{
    public static NamespaceDeclarationSyntax NamespaceDeclaration(SyntaxTokenList modifiers, SyntaxToken namespaceKeyword, NameSyntax name, SyntaxToken openBraceToken, SyntaxList<ImportDirectiveSyntax> importDirectives, SyntaxList<MemberDeclarationSyntax> members, SyntaxToken closeBraceToken, SyntaxToken? terminatorToken)
        => new NamespaceDeclarationSyntax(modifiers, namespaceKeyword, name, openBraceToken, importDirectives, members, closeBraceToken, terminatorToken);

    public static NamespaceDeclarationSyntax NamespaceDeclaration(SyntaxTokenList modifiers, SyntaxToken namespaceKeyword, NameSyntax name, SyntaxToken openBraceToken, SyntaxList<ImportDirectiveSyntax> importDirectives, SyntaxList<MemberDeclarationSyntax> members, SyntaxToken closeBraceToken)
        => new NamespaceDeclarationSyntax(modifiers, namespaceKeyword, name, openBraceToken, importDirectives, members, closeBraceToken, null);

    public static NamespaceDeclarationSyntax NamespaceDeclaration(SyntaxTokenList modifiers, NameSyntax name, SyntaxList<ImportDirectiveSyntax> importDirectives, SyntaxList<MemberDeclarationSyntax> members)
        => new NamespaceDeclarationSyntax(modifiers, name, importDirectives, members);
}