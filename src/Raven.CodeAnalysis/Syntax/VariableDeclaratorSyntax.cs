...
public partial class VariableDeclaratorSyntax : SyntaxNode
{
    ...
    public VariableDeclaratorSyntax(SyntaxToken identifier)
          : this(
                new InternalSyntax.VariableDeclaratorSyntax(identifier.Green, null, null), null)
    {
    ...
    public VariableDeclaratorSyntax(SyntaxToken identifier, TypeAnnotationClauseSyntax? typeAnnotation)
          : this(
                new InternalSyntax.VariableDeclaratorSyntax(identifier.Green, (InternalSyntax.TypeAnnotationClauseSyntax?)typeAnnotation?.Green, null), null)
    {
    ...
    public VariableDeclaratorSyntax(SyntaxToken identifier, EqualsValueClauseSyntax initializer)
      : this(
            new InternalSyntax.VariableDeclaratorSyntax(identifier.Green, null, (InternalSyntax.EqualsValueClauseSyntax)initializer?.Green), null)
    {
