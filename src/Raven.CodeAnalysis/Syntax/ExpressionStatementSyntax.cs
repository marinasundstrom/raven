...
public partial class ExpressionStatement1Syntax : ExpressionStatementSyntax
{
    ...
    public ExpressionStatement1Syntax(ExpressionSyntax expression, SyntaxToken terminationToken)
...
public partial class ExpressionStatement2Syntax : ExpressionStatementSyntax
{
    ...
    public ExpressionStatement2Syntax(ExpressionSyntax expression, SyntaxToken terminationToken)
        : this(new InternalSyntax.ExpressionStatement2Syntax((InternalSyntax.ExpressionSyntax)expression.Green, terminationToken.Green))
    {
    }
}
...
public static partial class SyntaxFactory
{
    ...
    public static ExpressionStatementSyntax ExpressionStatementWithSemicolon(ExpressionSyntax expression, SyntaxToken terminationToken)
        => new ExpressionStatement2Syntax(expression, terminationToken);
}