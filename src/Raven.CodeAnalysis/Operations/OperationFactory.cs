...
internal static class OperationFactory
{
    public static Operation? Create(SemanticModel semanticModel, SyntaxNode syntax, BoundNode bound)
    {
        ...
        return bound switch
        {
            ...
            BoundBreakExpression breakExpression => new BreakExpressionOperation(semanticModel, breakExpression, syntax, isImplicit),
            BoundContinueExpression continueExpression => new ContinueExpressionOperation(semanticModel, continueExpression, syntax, isImplicit),
            BoundYieldExpression yieldExpression => new YieldExpressionOperation(semanticModel, yieldExpression, syntax, isImplicit),
            BoundYieldBreakExpression yieldBreakExpression => new YieldBreakExpressionOperation(semanticModel, yieldBreakExpression, syntax, isImplicit),
            ...
            BoundLoopStatement loopStatement => new LoopStatementOperation(semanticModel, loopStatement, syntax, isImplicit),
            BoundLockStatement lockStatement => new LockOperation(semanticModel, lockStatement, syntax, isImplicit),
            ...
            BoundStackAllocExpression stackAlloc => new StackAllocOperation(semanticModel, stackAlloc, (StackAllocExpressionSyntax)syntax, isImplicit),
            ...
            BoundComparisonPattern relationalPattern => new ComparisonPatternOperation(semanticModel, relationalPattern, syntax, isImplicit),
            ...
            BoundDictionaryPattern dictionaryPattern => new DictionaryPatternOperation(semanticModel, dictionaryPattern, syntax, isImplicit),
            ...
            BoundDictionaryExpression dictionary => new DictionaryOperation(semanticModel, dictionary, syntax, isImplicit),
    ...
    private static OperationKind GetOperationKind(BoundNode bound)
    {
        return bound switch
        {
            ...
            BoundBreakExpression => OperationKind.BreakExpression,
            BoundContinueExpression => OperationKind.ContinueExpression,
            BoundYieldExpression => OperationKind.YieldExpression,
            BoundYieldBreakExpression => OperationKind.YieldBreakExpression,
            ...
            BoundLoopStatement => OperationKind.Loop,
            BoundLockStatement => OperationKind.Lock,
            ...
            BoundStackAllocExpression => OperationKind.StackAlloc,
            ...
            BoundComparisonPattern => OperationKind.ComparisonPattern,
            ...
            BoundDictionaryPattern => OperationKind.DictionaryPattern,
            ...
            BoundDictionaryExpression => OperationKind.Dictionary,
