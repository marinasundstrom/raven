...
internal static partial class CompilerDiagnostics
{
    ...
    private static DiagnosticDescriptor? _typeAlreadyDefined;
    private static DiagnosticDescriptor? _partialTypeDeclarationMissingPartial;
    ...
    private static DiagnosticDescriptor? _breakStatementInExpression;
    private static DiagnosticDescriptor? _continueStatementInExpression;
    private static DiagnosticDescriptor? _gotoStatementInExpression;
    private static DiagnosticDescriptor? _labelInExpression;
    ...
    /// <summary>
    /// RAV0600: A type named '{0}' is already defined in this scope
    /// </summary>
    public static DiagnosticDescriptor TypeAlreadyDefined => _typeAlreadyDefined ??= DiagnosticDescriptor.Create(
        id: "RAV0600",
        title: "Type already defined",
        description: "",
        helpLinkUri: "",
        messageFormat: "A type named '{0}' is already defined in this scope",
        category: "compiler",
        DiagnosticSeverity.Error,
        isEnabledByDefault: true);

    /// <summary>
    /// RAV0601: Type '{0}' has multiple declarations; all declarations must include the 'partial' modifier
    /// </summary>
    public static DiagnosticDescriptor PartialTypeDeclarationMissingPartial => _partialTypeDeclarationMissingPartial ??= DiagnosticDescriptor.Create(
        id: "RAV0601",
        title: "'partial' modifier missing",
        description: "",
        helpLinkUri: "",
        messageFormat: "Type '{0}' has multiple declarations; all declarations must include the 'partial' modifier",
        category: "compiler",
        DiagnosticSeverity.Error,
        isEnabledByDefault: true);
    ...
    /// <summary>
    /// RAV1902: Break statements are not valid in expressions; use a statement block instead
    /// </summary>
    public static DiagnosticDescriptor BreakStatementInExpression => _breakStatementInExpression ??= DiagnosticDescriptor.Create(
        id: "RAV1902",
        title: "Break statement not allowed here",
        description: "",
        helpLinkUri: "",
        messageFormat: "Break statements are not valid in expressions; use a statement block instead",
        category: "compiler",
        DiagnosticSeverity.Error,
        isEnabledByDefault: true);

    /// <summary>
    /// RAV1903: Continue statements are not valid in expressions; use a statement block instead
    /// </summary>
    public static DiagnosticDescriptor ContinueStatementInExpression => _continueStatementInExpression ??= DiagnosticDescriptor.Create(
        id: "RAV1903",
        title: "Continue statement not allowed here",
        description: "",
        helpLinkUri: "",
        messageFormat: "Continue statements are not valid in expressions; use a statement block instead",
        category: "compiler",
        DiagnosticSeverity.Error,
        isEnabledByDefault: true);

    /// <summary>
    /// RAV1904: Goto statements are not valid in expressions; use a statement block instead
    /// </summary>
    public static DiagnosticDescriptor GotoStatementInExpression => _gotoStatementInExpression ??= DiagnosticDescriptor.Create(
        id: "RAV1904",
        title: "Goto statement not allowed here",
        description: "",
        helpLinkUri: "",
        messageFormat: "Goto statements are not valid in expressions; use a statement block instead",
        category: "compiler",
        DiagnosticSeverity.Error,
        isEnabledByDefault: true);

    /// <summary>
    /// RAV1905: Labels are not valid in expressions; use a statement block instead
    /// </summary>
    public static DiagnosticDescriptor LabelInExpression => _labelInExpression ??= DiagnosticDescriptor.Create(
        id: "RAV1905",
        title: "Label not allowed here",
        description: "",
        helpLinkUri: "",
        messageFormat: "Labels are not valid in expressions; use a statement block instead",
        category: "compiler",
        DiagnosticSeverity.Error,
        isEnabledByDefault: true);
    ...
    /// <summary>
    /// RAV2500: A label named '{0}' is already defined in this scope
    /// </summary>
    public static DiagnosticDescriptor LabelAlreadyDefined => _labelAlreadyDefined ??= DiagnosticDescriptor.Create(
        id: "RAV2500",
        title: "Label already defined",
        description: "",
        helpLinkUri: "",
        messageFormat: "A label named '{0}' is already defined in this scope",
        category: "compiler",
        DiagnosticSeverity.Error,
        isEnabledByDefault: true);

    /// <summary>
    /// RAV2501: The label '{0}' does not exist in the current context
    /// </summary>
    public static DiagnosticDescriptor LabelNotFound => _labelNotFound ??= DiagnosticDescriptor.Create(
        id: "RAV2501",
        title: "Label not found",
        description: "",
        helpLinkUri: "",
        messageFormat: "The label '{0}' does not exist in the current context",
        category: "compiler",
        DiagnosticSeverity.Error,
        isEnabledByDefault: true);
    ...
    public static DiagnosticDescriptor BreakStatementNotWithinLoop => _breakStatementNotWithinLoop ??= DiagnosticDescriptor.Create(
        id: "RAV2600",
        title: "Break statement not within loop",
        description: "",
        helpLinkUri: "",
        messageFormat: "Break statements are only valid inside loops",
        category: "compiler",
        DiagnosticSeverity.Error,
        isEnabledByDefault: true);

    /// <summary>
    /// RAV2601: Continue statements are only valid inside loops
    /// </summary>
    public static DiagnosticDescriptor ContinueStatementNotWithinLoop => _continueStatementNotWithinLoop ??= DiagnosticDescriptor.Create(
        id: "RAV2601",
        title: "Continue statement not within loop",
        description: "",
        helpLinkUri: "",
        messageFormat: "Continue statements are only valid inside loops",
        category: "compiler",
        DiagnosticSeverity.Error,
        isEnabledByDefault: true);
    ...
    [
        ...
        TypeAlreadyDefined,
        PartialTypeDeclarationMissingPartial,
        ...
        BreakStatementInExpression,
        ContinueStatementInExpression,
        GotoStatementInExpression,
        LabelInExpression,
        NonInvocableMember,
    ...
    public static DiagnosticDescriptor? GetDescriptor(string diagnosticId) => diagnosticId switch
    {
        ...
        "RAV0600" => TypeAlreadyDefined,
        "RAV0601" => PartialTypeDeclarationMissingPartial,
        ...
        "RAV1902" => BreakStatementInExpression,
        "RAV1903" => ContinueStatementInExpression,
        "RAV1904" => GotoStatementInExpression,
        "RAV1905" => LabelInExpression,
