...
public partial class BoundNodeVisitorPartialGenerator : IIncrementalGenerator
{
    private static ClassDeclarationSyntax GenerateVisitorGenericPartialClass(SourceProductionContext context, INamedTypeSymbol? classSymbol)
    {
        ...
        return VisitorPartialGenerator.GeneratePartialClassWithVisitMethodForGenericVisitor(context, namespaceName, className, suffix: "Bound", visitorClassName: "BoundTree", resultType: "BoundNode", isInternal: true);
    }
}