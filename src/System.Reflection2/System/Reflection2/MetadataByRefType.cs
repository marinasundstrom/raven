...
/// <summary>
/// Represents a by-ref type within the metadata-only reflection universe.
/// </summary>
internal sealed class MetadataByRefType : TypeInfo
{
    private readonly Type _elementType;

    public MetadataByRefType(Type elementType)
    {
    ...
    public override Type? BaseType => _elementType.BaseType;
    ...
    public override Type GetGenericTypeDefinition() => throw new InvalidOperationException("By-ref types are not generic.");
    ...
    public override Type MakeGenericType(params Type[] typeArguments) => throw new InvalidOperationException("By-ref types are not generic.");
