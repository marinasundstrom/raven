...
internal sealed class RavenDocSiteTemplate
{
    ...
    public string RenderPage(RavenDocPageTemplateModel page)
    {
        ...
        <head>
          ...
          {(page.CustomStyleHref is null ? string.Empty : $"<link rel=\"stylesheet\" href=\"{Escape(page.CustomStyleHref)}\" />")}
          <script defer src="{Escape(page.ScriptHref)}"></script>
        </head>
        <body>
          <header class="site-header">
            <a class="raven-brand" href="{Escape(page.HomeHref)}">
              {(page.LogoHref is null ? "<span class=\"raven-brand-mark\">R</span>" : $"<img class=\"project-logo\" src=\"{Escape(page.LogoHref)}\" alt=\"\" />")}
