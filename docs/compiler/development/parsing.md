...
### In the `Lexer`
 ...
 For contextual parsing, you can create a checkpoint, by calling `CreateCheckpoint` in the parser. And then restore to that checkpoint by either calling the method `Rewind` or disposing the object.
