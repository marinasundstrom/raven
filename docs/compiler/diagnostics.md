...
| `RAV0402` | Error | Possible null reference access | Possible null reference access | Null-flow diagnostic; disable project-wide with `EnableNullFlowAnalysis=false`. Declared nullability, boundary checks, metadata, and pattern refinement remain active. See [Nullability, absence, and null flow](../lang/nullability.md). |
