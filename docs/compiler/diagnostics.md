...
| `RAV0402` | Error | Possible null reference access | Possible null reference access | Null-flow diagnostic; disable project-wide with `EnableNullFlowAnalysis=false`. Declared nullability remains enforced. |
