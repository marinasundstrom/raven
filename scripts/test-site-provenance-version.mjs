...
assert.deepEqual(
  getDocumentedVersionProvenance("0.1.6", true),
  { version: "0.1.6", status: "released" },
  "A released documented version remains released on later site commits.",
);
assert.deepEqual(
  getDocumentedVersionProvenance("0.1.6-preview.1", false),
  { version: "0.1.6-preview.1", status: "unreleased" },
);
assert.throws(
