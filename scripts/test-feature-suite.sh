...
case "$suite" in
  ...
  partials)
    ...
    ;;
  macros)
    filter="(FullyQualifiedName~.FreestandingMacroParsingTests.|FullyQualifiedName~.MacroDeclarationParsingTests.|FullyQualifiedName~.FreestandingMacroSemanticTests.|FullyQualifiedName~.MacroSymbolTests.|FullyQualifiedName~.MacroAttributeSemanticTests.|FullyQualifiedName~.MacroExpandedDocumentTests.|FullyQualifiedName~.FreestandingMacroCodeGenTests.|FullyQualifiedName~.MacroCodeGenTests.|FullyQualifiedName~MacroDeclarationsSample_RunsThroughDotnetBuild)"
    ;;
  imports-and-namespaces)
