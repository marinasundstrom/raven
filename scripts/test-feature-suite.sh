...
case "$suite" in
  ...
  partials)
    ...
    ;;
  macros)
    filter="(FullyQualifiedName~.InvocableMacroParsingTests.|FullyQualifiedName~.MacroDeclarationParsingTests.|FullyQualifiedName~.InvocableMacroSemanticTests.|FullyQualifiedName~.MacroSymbolTests.|FullyQualifiedName~.MacroAttributeSemanticTests.|FullyQualifiedName~.MacroExpandedDocumentTests.|FullyQualifiedName~.InvocableMacroCodeGenTests.|FullyQualifiedName~.MacroCodeGenTests.|FullyQualifiedName~MacroDeclarationsSample_RunsThroughDotnetBuild)"
    ;;
  imports-and-namespaces)
