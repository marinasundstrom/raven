...
case "$suite" in
  ...
  partials)
    ...
    ;;
  macros)
    filter="(FullyQualifiedName~.FreestandingMacroParsingTests.|FullyQualifiedName~.MacroDeclarationParsingTests.|FullyQualifiedName~.FreestandingMacroSemanticTests.|FullyQualifiedName~.MacroSymbolTests.|FullyQualifiedName~.AttachedMacroSemanticTests.|FullyQualifiedName~.MacroExpandedDocumentTests.|FullyQualifiedName~.FreestandingMacroCodeGenTests.|FullyQualifiedName~.AttachedMacroCodeGenTests.|FullyQualifiedName~MacroDeclarationsSample_RunsThroughDotnetBuild)"
    ;;
  imports-and-namespaces)
