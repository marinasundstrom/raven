...
RAVEN_CORE_OUT="$ROOT_DIR/src/Raven.Core/bin/$BUILD_CONFIG/net10.0/Raven.Core.dll"
...
dotnet run -f net10.0 --project "$ROOT_DIR/src/Raven.Compiler/Raven.Compiler.csproj" --no-restore -p:UseRavenCoreReference=false \
